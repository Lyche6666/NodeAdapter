...
#[derive(Debug)]
pub struct NodeAdapterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeAdapterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeAdapter processing");
    
    let mut processor = NodeAdapterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeAdapterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeAdapterProcessor::new(false);
